  ...
  const calculateResults = async () => {
    try {
      ...
      const room = roomData ? JSON.parse(roomData) : { 
        length: '5.0', width: '4.0', height: '3.0', doorWidth: '1.2', doorHeight: '2.1',
        doorOpenings: '20', insulationType: 'PUF', insulationThickness: 100 
      };
      
      const conditions = conditionsData ? JSON.parse(conditionsData) : { 
        externalTemp: '35', internalTemp: '4', operatingHours: '24', pullDownTime: '6' 
      };
      ...
      const product = productData ? JSON.parse(productData) : { 
        productType: 'Vegetables (Mixed)', dailyLoad: '2000', incomingTemp: '25', outgoingTemp: '4',
        storageType: 'Palletized', numberOfPeople: '2', workingHours: '6',
        lightingWattage: '200', equipmentLoad: '500' 
      };
    ...
    <LinearGradient colors={['#F8FAFC', '#EBF8FF']} style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.mainResultCard}>
          ...
          <Text style={styles.mainResultSubtitle}>Daily Energy: {(results.totalLoadWithSafety * 24).toFixed(1)} kWh</Text>
          <Text style={styles.mainResultSubtitle}>Refrigeration: {results.refrigerationTons.toFixed(2)} TR</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.breakdownCard}>
            ...
            <View style={styles.breakdownRow}>
              <Text style={styles.breakdownLabel}>Sensible heat load:</Text>
              <Text style={styles.breakdownValue}>{results.productLoad.sensible.toFixed(3)} kW</Text>
            </View>
            <View style={[styles.breakdownRow, styles.subtotalRow]}>
